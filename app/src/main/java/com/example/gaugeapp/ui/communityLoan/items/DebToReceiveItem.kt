...
import kotlinx.android.synthetic.main.item_deb_to_receive.view.*

class DebToReceiveItem() : Item() {
    override fun bind(viewHolder: ViewHolder, position: Int) {
        ...
        Glide.with(viewHolder.itemView)
            ...
            .circleCrop()
            .into(viewHolder.itemView.id_dep_to_receive_user_image)
    }

    override fun getLayout() = R.layout.item_deb_to_receive
}