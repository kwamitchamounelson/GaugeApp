...
import kotlinx.android.synthetic.main.item_deb_to_pay_back.view.*

class DebToPayBackItem() : Item() {
    override fun bind(viewHolder: ViewHolder, position: Int) {
        ...
        Glide.with(viewHolder.itemView)
            ...
            .circleCrop()
            .into(viewHolder.itemView.id_dep_user_image)
    }

    override fun getLayout() = R.layout.item_deb_to_pay_back
}